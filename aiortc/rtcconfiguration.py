...
class RTCConfiguration:
	...
	videoPacketRecorder = attr.ib(default=None)
	audioPacketRecorder = attr.ib(default=None)
	videoPacketReplay 	= attr.ib(default=None)
	audioPacketReplay 	= attr.ib(default=None)
